...
const expected = new Set(["semantic-contract", "datalog-corpus", "python-reference", "souffle-kernel", "datalog-differential", "datalog-certificates", "datalog-fg-go", "datalog-evaluation"]);
...
const artifacts = {
  ...
  "datalog-fg-go": ["packages/capabilities/experiments/claim-semantics"],
...
if (task === "datalog-fg-go") assert.ok(process.env.CAPCOV_GO_FIXTURE_ROOT, "CAPCOV_GO_FIXTURE_ROOT is required");
