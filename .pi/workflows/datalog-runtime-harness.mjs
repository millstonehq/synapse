...
const expected = new Set(["semantic-contract", "datalog-corpus", "python-reference", "souffle-kernel", "kernel-closure", "differential-closure", "kernel-closure-integrate", "scip-toolchain", "scip-fact-export", "static-rule-pack", "scip-datalog-differential", "datalog-certificates", "scip-fg-go-pilot", "datalog-fg-go", "datalog-evaluation"]);
