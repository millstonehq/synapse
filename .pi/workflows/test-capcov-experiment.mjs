...
const modern = ["semantic-contract", "datalog-corpus", "python-reference", "souffle-kernel", "datalog-differential", "scip-toolchain", "scip-fact-export", "static-rule-pack", "scip-datalog-differential", "datalog-certificates", "scip-fg-go-pilot", "datalog-fg-go", "datalog-evaluation"];
