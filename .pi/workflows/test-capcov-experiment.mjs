...
const modern = ["semantic-contract", "datalog-corpus", "python-reference", "souffle-kernel", "datalog-differential", "datalog-certificates", "datalog-fg-go", "datalog-evaluation"];
